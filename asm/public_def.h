...
//RTSP response codes applicable to interface S6
#define RTSP_S6_ResponseCode_OK                                       200 //OK
#define RTSP_S6_ResponseCode_BadRequest                          400 //N/A
#define RTSP_S6_ResponseCode_Forbidden                            403 //N/A
#define RTSP_S6_ResponseCode_NotFound                            404 //TSID not found; TSID does not exist on this Edge QAM, or invalid URL
#define RTSP_S6_ResponseCode_MethodNotAllowed             405 //Method Not Allowed. Example = Play
#define RTSP_S6_ResponseCode_NotAcceptable                     406 //N/A
#define RTSP_S6_ResponseCode_RequestTimeOut                  408 //Request Time Out
#define RTSP_S6_ResponseCode_Gone                                    410 //N/A
#define RTSP_S6_ResponseCode_RequestEntityTooLarge         413 //N/A
#define RTSP_S6_ResponseCode_UnsupportedMediaType	      415 //N/A
#define RTSP_S6_ResponseCode_InvalidParameter		      451 //Invalid Parameter
#define RTSP_S6_ResponseCode_NotEnoughBandwidth          453 //QAM Bandwidth Exceeded
#define RTSP_S6_ResponseCode_SessionNotFound                 454 //Session Not Found
#define RTSP_S6_ResponseCode_InvalidRange                        457 //Invalid Range
#define RTSP_S6_ResponseCode_AggregateOperationNotAllowed                              459 //N/A
#define RTSP_S6_ResponseCode_UnsupportedTransport                                             461 //Unsupported Transport
#define RTSP_S6_ResponseCode_DestinationUnreachable                                           462 //Invalid Destination IP Address in Transport specification.
#define RTSP_S6_ResponseCode_GatewayTimeout                                                      504 //N/A
#define RTSP_S6_ResponseCode_RTSPVersionNotSupported                                       505 //RTSP Version Not Supported
#define RTSP_S6_ResponseCode_ERMSetupFailed_InvalidRequest                                671 //The ERM failed to parse the request from the SM
#define RTSP_S6_ResponseCode_ERMSetupFailed_QAMBandwidthNotAvailable           672 //No bandwidth was available on any suitable QAM.
#define RTSP_S6_ResponseCode_ERMSetupFailed_NetworkBandwidthNotAvailable 	   673  //No suitable network bandwidth was available to perform this request.
#define RTSP_S6_ResponseCode_ERMSetupFailed_ProgramNotAvailable			   674 //No suitable program was available to perform this request.
#define RTSP_S6_ResponseCode_ERMSetupFailed_ServiceGroupNotFound                   675  //The service group specified in the request was not found.
#define RTSP_S6_ResponseCode_ERMSetupFailed_QAMGroupsNotFound 		   676 //The QAM group(s) specified in the request was/were not found.
#define RTSP_S6_ResponseCode_ERMSetupFailed_QAMNotAvailable			   677  //No suitable QAM was available to carry out the specified request.
#define RTSP_S6_ResponseCode_ERMSetupFailed_EdgeDeviceNotAvailable                  678  //No suitable Edge Device was available to carry out the specified request.
